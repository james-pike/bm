...
export const allProducts = [
  ...
  { sku: "CM-7", name: "Women's Golf Polo", category: "Polos", sizes: "XS - 4XL", badge: "", colors: ["#1a1a18", "#00703c", "#94a3b8"], price: 40, img: "https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=440&h=330&fit=crop", imgs: ["https://images.unsplash.com/photo-1618354691373-d851c5c3a990?w=600&h=400&fit=crop", "https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?w=600&h=400&fit=crop", "https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=600&h=400&fit=crop"], material: "100% performance polyester micropique", details: "Snag resistant, moisture-wicking, breathable, tagless, self-fabric collar, relaxed fit" },
  ...
  { sku: "CM-12", name: "Carmichael Flip Toque", category: "Caps", sizes: "One Size", badge: "", colors: ["#1a1a18", "#2c3e50", "#4a4a4a"], price: 7, img: "https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?w=440&h=330&fit=crop", imgs: ["https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?w=600&h=400&fit=crop", "/beanie/1.png", "/hat/30109107PS2_FRONT.JPG"], material: "100% Acrylic", details: "Traditional knit hat with cuff, one size fits most" },
  { sku: "CM-13", name: "Embroidered Cap", category: "Caps", sizes: "One Size", badge: "Popular", colors: ["#00703c", "#1a1a18", "#2c3e50"], price: 24, img: "/hat/30109107PS2_FRONT.JPG", imgs: ["/hat/30109107PS2_FRONT.JPG", "/hat/30109107PS2_BACK.JPG", "/beanie/1.png", "https://images.unsplash.com/photo-1576871337632-b9aef4c17ab9?w=600&h=400&fit=crop"], pdf: "/hat/30131741.pdf", material: "", details: "" },
];

export type Product = typeof allProducts[0];

export const categories = ["All", "Polos", "Jackets", "Caps"];
